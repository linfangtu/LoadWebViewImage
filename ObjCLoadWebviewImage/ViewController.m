...
//    NSURL *url = [NSURL URLWithString:@"http://wap.sometimes.net.cn/wechat/column.html?id=89"];
    NSString *html = [[NSString alloc] initWithContentsOfURL:url encoding:NSUTF8StringEncoding error:nil];
  
    [[LoadWebViewImage sharedManager] loadImageWithHtmlContent:html webView:self.webView baseUrl:url];
